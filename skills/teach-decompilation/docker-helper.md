...
3. **Decompile:**
   ```bash
   $ poetry run tiny-dec decompile user_code.elf --stage <stage> --func main
   ```
...
$ poetry run tiny-dec decompile user_code_O0.elf --stage ssa --func main
$ poetry run tiny-dec decompile user_code_O2.elf --stage ssa --func main
```
