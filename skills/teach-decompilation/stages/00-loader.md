...
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_basic_O0_nopie.elf --stage loader --func main
```
...
```bash
$ poetry run tiny-dec info tests/fixtures/bin/fixture_basic_O0_nopie.elf
$ poetry run tiny-dec info tests/fixtures/bin/fixture_basic_O2_pie.elf
```
