...
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_loop_O0_nopie.elf --stage aggregate_types --func sum_to_n

# After variable recovery
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_loop_O0_nopie.elf --stage variables --func sum_to_n
```
...
```bash
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage variables --func parse_record
```
