...
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --func parse_record

# Compare C lowering (stage 17) with final C (stage 18)
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage c_lowering --func parse_record
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage c --func parse_record
```
...
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage decode --func parse_record
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage ssa --func parse_record
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage aggregate_types --func parse_record
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --stage structuring --func parse_record
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_struct_O0_nopie.elf --func parse_record
```
