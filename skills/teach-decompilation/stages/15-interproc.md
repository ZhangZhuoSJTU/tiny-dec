...
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_basic_O0_nopie.elf --stage interproc --func main

# Also check the callee
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_basic_O0_nopie.elf --stage interproc --func helper
```
...
```bash
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_chain_O0_nopie.elf --stage interproc --func main
```
