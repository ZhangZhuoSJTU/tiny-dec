...
```bash
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_loop_O0_nopie.elf --stage c_lowering --func sum_to_n
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_loop_O2_nopie.elf --stage c_lowering --func sum_to_n
```
