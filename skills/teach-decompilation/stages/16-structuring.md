...
```bash
# Structure a loop
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_loop_O0_nopie.elf --stage structuring --func sum_to_n

# Structure a switch
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_switch_O0_nopie.elf --stage structuring --func dispatch

# Structure nested control flow
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_nested_O0_nopie.elf --stage structuring --func main
```
...
```bash
$ poetry run tiny-dec decompile tests/fixtures/bin/fixture_switch_loop_O0_nopie.elf --stage structuring --func main
```
